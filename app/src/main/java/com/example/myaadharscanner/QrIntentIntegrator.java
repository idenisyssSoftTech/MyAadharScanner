...
public class QrIntentIntegrator extends  Object{
...
//hi soumya testmode proccess2
    ...
    public QrIntentIntegrator(Activity activity) {
     ...
     */
    public QrIntentIntegrator setCaptureActivity(Class<?> captureActivity) {
     ...
     * @return this
     */
    public QrIntentIntegrator setRequestCode(int requestCode) {
     ...
     *                 of an {@link Activity}
     */
    public static QrIntentIntegrator forSupportFragment(androidx.fragment.app.Fragment fragment) {
        QrIntentIntegrator integrator = new QrIntentIntegrator(fragment.getActivity());
    ...
    public static QrIntentIntegrator forFragment(Fragment fragment) {
        QrIntentIntegrator integrator = new QrIntentIntegrator(fragment.getActivity());
    ...
    public final QrIntentIntegrator addExtra(String key, Object value) {
     ...
     */
    public final QrIntentIntegrator setPrompt(String prompt) {
        if (prompt != null) {
     ...
     */
    public QrIntentIntegrator setOrientationLocked(boolean locked) {
     ...
     * @return this
     */
    public QrIntentIntegrator setCameraId(int cameraId) {
        if (cameraId >= 0) {
     ...
     * @return this
     */
    public QrIntentIntegrator setTorchEnabled(boolean enabled) {
     ...
     * @return this
     */
    public QrIntentIntegrator setBeepEnabled(boolean enabled) {
     ...
     * @return this
     */
    public QrIntentIntegrator setBarcodeImageEnabled(boolean enabled) {
     ...
     * @return this
     */
    public QrIntentIntegrator setDesiredBarcodeFormats(Collection<String> desiredBarcodeFormats) {
     ...
     * @return this
     */
    public QrIntentIntegrator setDesiredBarcodeFormats(String... desiredBarcodeFormats) {
     ...
     */
    public QrIntentIntegrator setTimeout(long timeout) {
    ...
    public static QrIntentResult parseActivityResult(int requestCode, int resultCode, Intent intent) {
     ...
     */
    public static QrIntentResult parseActivityResult(int resultCode, Intent intent) {
        if (resultCode == Activity.RESULT_OK) {
            ...
            return new QrIntentResult(contents,
                    formatName,
                    rawBytes,
                    orientation,
        ...
        return new QrIntentResult(intent);
    }
